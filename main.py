...
class TestWA(unittest.TestCase):
    ...
    def test_dob(self):
        ...
        print(query, result_test, result_wolf)
        # Test both equal
    ...
    def test_quadratic(self):
        ...
        result_wolf = [index['plaintext'].split(
            "=")[1] for index in result_wolf]
    ...
    def test_hash(self):
        ...
        result_wolf = self.api.search(query)
        result_wolf = self.api.get_pod(result_wolf, "Message digest")[
            0]['plaintext']
        print(query, result_test, result_wolf)
    ...
    def test_truth_table(self):
        ...
        result_wolf = self.api.search(query)
        result_wolf = self.api.get_pod(result_wolf, "Truth table")[
    ...
    def test_math(self):
        ...
        result_wolf = self.api.search(query)
        result_wolf = self.api.get_pod(result_wolf, "Exact result")[
            0]['plaintext']
    ...
    def test_sum(self):
        ...
        result_wolf = self.api.search(query)
        result_wolf = float(self.api.get_pod(
            result_wolf, "Result")[0]['plaintext'])
        min_deci = len(str(result_wolf).split('.')[1]) if len(str(result_wolf).split('.')[
            1]) < len(str(result_test).split('.')[1]) else len(str(result_test).split('.')[1])
        print(query, result_test, result_wolf)
        self.assertEqual(f'%.{min_deci}f' % result_test,
                         f'%.{min_deci}f' % result_wolf)
    ...
    def test_derivative(self):
        ...
        result_wolf = self.api.search(query)
        result_wolf = self.api.get_pod(result_wolf, "Derivative")[
            0]['plaintext']
    ...
    # python main.py TestWA.test_nutrition
